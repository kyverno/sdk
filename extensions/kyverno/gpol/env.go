	...
	extendedBase, err := base.Extend(
		...
		environment.VersionedOptions{
			...
			EnvOptions: []cel.EnvOption{
				...
				// generator.Lib registers the "generator" variable and generator.Apply() function.
				// nil context is intentional for compilation; the real context is injected per-evaluation.
				generator.Lib(
					nil,
					"",
					generator.Latest(),
